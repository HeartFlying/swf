...
| 3 | 用户交互 | 澄清模糊内容，收集缺失信息 |
| 4 | 场景延伸分析 | 从时间/空间/角色/频次维度延伸场景 |
| 5 | 痛点深度挖掘 | 使用 5Why 分析法挖掘表层/中层/深层痛点 |
| 6 | 期望价值推导 | 推导功能/效率/情感/社交价值 |
| 7 | 竞品对标分析 | 分析功能/体验/模式差距 |
| 8 | 趋势预判 | 预判技术/用户/行业趋势 |
| 9 | 需求去重与验证 | 与显性需求对比，识别重复和矛盾 |
| 10 | 置信度评估 | 评估需求的高/中/低置信度 |
| 11 | 生成报告 | 使用模板生成隐式需求报告 |
| 12 | 更新 Todo-List | 更新任务状态和进度 |
| 13 | 后置校验 | 验证产物格式和内容完整性 |
| 14 | 用户评审 | 展示结果，收集用户反馈 |
