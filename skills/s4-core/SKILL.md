...
| 产物名称 | 产物ID | 存储路径 | 说明 |
|---------|--------|---------|------|
| 核心需求提取报告 | `{PlanID}-S4-S403-001` | `database/stages/s4/{PlanID}-S4-S403-001.md` | 主产物，包含核心功能清单、MVP范围、需求分层 |
| MVP范围定义文档 | `{PlanID}-S4-S403-002` | `database/stages/s4/{PlanID}-S4-S403-002.md` | MVP目标、功能清单、验收标准 |
