...
|---------|---------|---------|------|------|
| 显性需求 | S102 | {N} | {X}% | 用户明确表达的需求 |
| 隐性需求 | S203 | {N} | {X}% | 推导出的隐性需求 |
| 功能需求 | S401 | {N} | {X}% | 按功能分类的需求 |
| 用户需求 | S401 | {N} | {X}% | 按用户分类的需求 |
| 系统需求 | S401 | {N} | {X}% | 按系统分类的需求 |
| 业务需求 | S401 | {N} | {X}% | 按业务分类的需求 |
| **去重后总计** | - | **{N}** | **100%** | - |
...
|--------|---------|---------|--------|------|---------|---------|------|
| R001 | 任务创建 | S102 | P0 | MVP | TaskModule | TC001-TC007 | 已定义 |
| R002 | 日程安排 | S102 | P0 | MVP | CalendarModule | TC008-TC012 | 已定义 |
| R003 | 番茄钟 | S203 | P1 | MVP | PomodoroModule | TC013-TC017 | 已定义 |
...
| 文档名称 | 文档 ID | 说明 |
|---------|--------|------|
| 需求边界界定 | {PlanID}-S1-S101-001 | S101 产物 |
| 显性需求提取 | {PlanID}-S1-S102-001 | S102 产物 |
| 隐性需求挖掘 | {PlanID}-S1-S203-001 | S203 产物 |
| 需求验证报告 | {PlanID}-S1-S204-001 | S204 产物 |
| 需求分类梳理 | {PlanID}-S4-S401-001 | S401 产物 |
| 需求优先级排序 | {PlanID}-S4-S402-001 | S402 产物 |
| 需求风险识别 | {PlanID}-S3-S301-001 | S301 产物 |
| 竞品分析报告 | {PlanID}-S2-S201-001 | S201 产物 |
| 市场痛点验证 | {PlanID}-S2-S202-001 | S202 产物 |
| 技术可行性评估 | {PlanID}-S3-S302-001 | S302 产物 |
| 技术选型报告 | {PlanID}-S3-S303-001 | S303 产物 |
