...
|-----|------|
| **PlanID** | {PlanID} |
| **产物 ID** | {PlanID}-S3-S301-001-RISK |
| **Skill 编号** | S301 |
| **Skill 名称** | 需求风险识别 |
| **所属阶段** | S3 - 技术可行性与选型阶段 |
| **前置依赖** | S202-市场痛点验证、S201-竞品分析、S104-需求验证 |
...
| 文档名称 | 类型 | 路径/来源 | 说明 |
|---------|------|----------|------|
| 市场痛点验证报告 | 前置产物 | {PlanID}-S2-S202-001-validation.md | S202 产物 |
| 竞品分析报告 | 前置产物 | {PlanID}-S2-S201-001-analysis.md | S201 产物 |
| 需求验证报告 | 前置产物 | {PlanID}-S1-S104-001-validation.md | S104 产物 |
