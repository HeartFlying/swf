...
| **Skill 名称** | 需求风险识别 |
| **所属阶段** | S3 - 技术可行性与选型阶段 |
| **前置依赖** | S102-市场验证、S101-竞品分析、S204-需求验证 |
...
| 文档名称 | 类型 | 路径/来源 | 说明 |
|---------|------|----------|------|
| 市场验证报告 | 前置产物 | {PlanID}-S1-S102-001-validation.md | S102 产物 |
| 竞品分析报告 | 前置产物 | {PlanID}-S1-S101-001-analysis.md | S101 产物 |
| 需求验证报告 | 前置产物 | {PlanID}-S2-S204-001-validation.md | S204 产物 |
