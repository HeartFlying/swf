...
> **引用路径**：`../_shared/error-code-standard.md`
...
| 代码 | 错误名称 | 说明 |
|------|----------|------|
| E131 | 技术可行性判定失败 | 可行性评估异常 |
| E132 | 技术选型冲突 | 选型结果存在冲突 |
| E133 | 非功能需求定义失败 | 非功能需求定义异常 |
| E134 | 风险评估失败 | 无法完成风险评估 |
...
| 代码 | 错误名称 | 说明 |
|------|----------|------|
| E151 | 架构视图生成失败 | 无法生成架构视图 |
| E152 | 接口定义冲突 | 接口定义存在矛盾 |
| E153 | 部署策略不合理 | 部署方案不可行 |
| E154 | 架构验证失败 | 架构评审未通过 |
...
|------|----------|------|
| E161 | 模块设计失败 | 模块划分异常 |
| E162 | 数据库设计失败 | 数据模型设计异常 |
| E163 | UI/UX设计失败 | 界面设计异常 |
| E164 | 测试策略定义失败 | 测试方案生成异常 |

### CM-001 - 变更管理

| 代码 | 错误名称 | 说明 |
|------|----------|------|
| E171 | 变更影响分析失败 | 无法评估变更影响 |
| E172 | 变更冲突检测失败 | 变更冲突检测异常 |
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| v1.0 | 2026-03-27 | 初始版本，统一27个Skill的错误代码体系 |
