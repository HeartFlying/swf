...
| **执行顺序** | S6 阶段第 4 个执行 |
| **执行模式** | 自动推导 + 用户交互 |
| **存储目录** | skills/s6-test-strategy |
| **依赖 Skill** | S6-A03 (UI/UX 设计) |
| **后置 Skill** | 无（S6 阶段最后执行） |
| **轻量化跳过** | No |
| **必需输入** | artifacts/stages/s6/{PlanID}-S6-A03-001.md |
| **输出产物** | artifacts/stages/s6/{PlanID}/{PlanID}-S6-A04-001.md |
...
S6-A04 产物规范遵循 [../_shared/artifact-specifications.md](../_shared/artifact-specifications.md) 中的通用定义。
...
S6-A04 遵循 [../_shared/quality-standard.md](../_shared/quality-standard.md) 中的 ISO/IEC 25010 质量评估框架。
