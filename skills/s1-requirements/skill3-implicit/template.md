...
本模板用于 Skill3（隐性需求挖掘）的输出产物：**隐性需求挖掘报告**。

**产物 ID 格式**：`{PlanID}-S1-S03-001-implicit`

**存储路径**：`database/stages/s1/{PlanID}/{PlanID}-S1-S03-001-implicit.md`
...
|-----|------|
| **Plan ID** | {PlanID} |
| **报告 ID** | {PlanID}-S1-S03-001-implicit |
| **生成时间** | {ISO 时间戳} |
| **Skill 版本** | 2.0 |
| **执行模式** | normal |
...
| **执行耗时** | {N}ms |
| **下次执行** | S1-S04 (需求验证) |
| **产物路径** | `database/stages/s1/{PlanID}/{PlanID}-S1-S03-001-implicit.md` |

---

*本报告由 Skill3-隐性需求挖掘 自动生成，遵循 IEEE 29148-2011 标准*
```
