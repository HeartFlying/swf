...
| 所属 PlanID | {PlanID} |
| 所属阶段 | S3 - 技术可行性与选型阶段 |
| 前置依赖 Skill | Skill10-市场痛点验证、Skill7-需求风险识别（可选） |
| 产物唯一 ID | {PlanID}-S3-S11-001 |
...
- 前置产物 ID：{PlanID}-S2-S10-001（市场痛点验证报告）
- 可选产物 ID：{PlanID}-S3-S07-001（需求风险识别报告）
...
|---------|---------|------|--------|--------|
| 市场痛点验证报告 | 前置产物 | Skill10 输出 | 需求清单、市场价值 | 高 |
| 需求风险识别报告 | 前置产物 | Skill7 输出 | 风险清单 | 中/高 |
...
- [Skill11 定义文档](../SKILL.md)
- [市场痛点验证报告模板](../../s2-market/skill10-market/template.md)
- [需求风险识别报告模板](../skill7-risk/template.md)
- [技术可行性评估最佳实践](参考文档链接)
