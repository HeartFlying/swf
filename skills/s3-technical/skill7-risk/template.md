...
| **Skill 名称** | 需求风险识别 |
| **所属阶段** | S3 - 技术可行性与选型阶段 |
| **前置依赖** | Skill10-市场痛点验证、Skill9-竞品分析、Skill4-需求验证 |
| **执行日期** | {YYYY-MM-DD} |
| **执行 Agent** | Executor Agent |
| **产物版本** | 2.0（标准化版本） |
| **核心内容摘要** | {风险识别结果概述，≤50 字} |
| **用户交互记录** | {无/具体内容} |
...
| 文档名称 | 类型 | 路径/来源 | 说明 |
|---------|------|----------|------|
| Skill7 定义文档 | Skill 定义 | [../SKILL.md](../SKILL.md) | Skill7 的完整规范 |
| 市场痛点验证报告 | 前置产物 | {PlanID}-S2-S10-001-validation.md | Skill10 产物 |
| 竞品分析报告 | 前置产物 | {PlanID}-S2-S09-001-analysis.md | Skill9 产物 |
| 需求验证报告 | 前置产物 | {PlanID}-S1-S04-001-validation.md | Skill4 产物 |
| IEEE 31000-2019 | 标准 | 外部标准 | 风险管理标准 |
| PMBOK Guide | 指南 | 外部指南 | 项目管理知识体系指南 |

### E. JSON Schema

完整的结构化数据定义参见 [../SKILL.md](../SKILL.md) 第四部分。
