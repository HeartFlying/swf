...
| 场景 | 说明 | 示例 |
|------|------|------|
| 信息缺失 | 关键字段未提供 | 架构风格未明确 |
| 描述模糊 | 存在歧义或模糊词汇 | "高性能"、"可扩展" |
| 矛盾信息 | 输入存在逻辑冲突 | 预算与功能需求不匹配 |
| 方案选择 | 存在多个可行方案 | 分层架构选择、模块拆分策略 |
...
1. **需求澄清模板**：`references/user-interaction/clarification-template.md`
2. **信息收集模板**：`references/user-interaction/information-collection-template.md`
3. **方案选择模板**：`references/user-interaction/option-selection-template.md`
...
|------|------|------|----------|----------|----------|
| 1 | 2026-03-28 10:00 | 方案选择 | 分层架构选择 | B | 已处理 |
```
...
| 第2轮 | 2026-03-28 14:00 | 需修改 | 需要补充XX模块 | 已处理 |
```
...
详细错误代码参见 [error-code-standard.md](error-code-standard.md)
