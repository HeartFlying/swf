...
- [ ] **Skill0: Plan 制定**
  ...
  - **评审方式**: 必须评审 ⭐
  - **输入**: 用户原始需求
  - **输出文档**: `database/{PlanID}/00-plan.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill1: 需求边界界定**
  ...
  - **评审方式**: AI自检
  - **输入文档**: `00-plan.md`
  - **输出文档**: `database/{PlanID}/01-boundary.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill2: 显性需求提取**
  ...
  - **评审方式**: AI自检
  - **输入文档**: `01-boundary.md`
  - **输出文档**: `database/{PlanID}/02-explicit.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill3: 隐性需求挖掘**（常规模式执行，轻量化模式跳过）
  ...
  - **评审方式**: AI自检
  - **输入文档**: `02-explicit.md`
  - **输出文档**: `database/{PlanID}/03-implicit.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill4: 需求验证**
  ...
  - **输出文档**: `database/{PlanID}/04-validation.md`（S1 阶段汇总）
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill9: 竞品分析**
  ...
  - **输出文档**: `database/{PlanID}/09-competitor.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill10: 市场痛点验证**
  ...
  - **输出文档**: `database/{PlanID}/10-market.md`（S2 阶段汇总）
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill7: 需求风险识别**
  ...
  - **输出文档**: `database/{PlanID}/07-risk.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill11: 技术可行性评估**
  ...
  - **评审方式**: AI自检
  - **输入文档**: `04-validation.md` / `10-market.md`
  - **输出文档**: `database/{PlanID}/11-feasibility.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill12: 轻量化技术选型**
  ...
  - **输出文档**: `database/{PlanID}/12-selection.md`（S3 阶段汇总）
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill5: 需求分类梳理**
  ...
  - **输出文档**: `database/{PlanID}/05-classify.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill6: 需求优先级排序**
  ...
  - **评审方式**: AI自检
  - **输入文档**: `05-classify.md`
  - **输出文档**: `database/{PlanID}/06-priority.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill8: 核心需求提炼**
  ...
  - **评审方式**: 必须评审 ⭐
  - **输入文档**: `06-priority.md`
  - **输出文档**: `database/{PlanID}/08-core.md`（最终产物）
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
...
- [ ] **Skill15: 原型设计**（可选，常规模式）
  ...
  - **评审方式**: 用户请求时执行
  - **输入文档**: `08-core.md`
  - **输出文档**: `database/{PlanID}/15-prototype.md`
  - **评审状态**: 待评审 / 已通过 / 需修改
  - **评审意见**: {用户评审意见记录}
  - **开始时间**: {日期时间}
  - **完成时间**: {日期时间}
